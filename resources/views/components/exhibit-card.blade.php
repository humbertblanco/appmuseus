...
<a
    ...
    class="group block bg-white rounded-xl shadow-sm hover:shadow-lg hover:ring-2 hover:ring-primary-700 transition-all duration-300 overflow-hidden"
>
    <div class="aspect-video bg-gray-200 relative overflow-hidden">
        ...
        @if($teAudioAD || $teTranscripcio)
            <div class="absolute bottom-3 right-3 flex gap-1.5">
                ...
                <div class="bg-primary-700 text-white px-2 py-1 rounded-full flex items-center gap-1 text-xs font-medium shadow-lg" title="Audiodescripció (persones cegues)">
                ...
                <div class="bg-primary-700 text-white px-2 py-1 rounded-full flex items-center gap-1 text-xs font-medium shadow-lg" title="Transcripció (persones sordes)">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="p-5 lg:p-6">
        <h2 class="text-lg lg:text-xl font-semibold text-gray-900 group-hover:text-primary-700 transition-colors">
