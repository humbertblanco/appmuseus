...
<div class="bg-white min-h-screen">
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div class="space-y-3 text-sm">
                    ...
                    @if($traduccio->telefon)
                        <div class="flex items-center gap-3">
                            ...
                            <a href="tel:{{ $traduccio->telefon }}" class="text-gray-600 hover:text-red-700">{{ $traduccio->telefon }}</a>
                        </div>
                    @endif
                    ...
                    @if($traduccio->email)
                        <div class="flex items-center gap-3">
                            ...
                            <a href="mailto:{{ $traduccio->email }}" class="text-gray-600 hover:text-red-700">{{ $traduccio->email }}</a>
                        </div>
                    @endif
                    ...
                    @if($traduccio->web_url)
                        <div class="flex items-center gap-3">
                            ...
                            <a href="{{ $traduccio->web_url }}" target="_blank" class="text-gray-600 hover:text-red-700">Web del museu</a>
                        </div>
                    @endif
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            @if(request()->has('ad'))
            <div class="flex items-center gap-2 px-3 py-1.5 bg-red-100 text-red-700 rounded-full text-sm font-medium">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @foreach($pecesAMostrar as $peca)
                    ...
                    >
                        <div class="relative">
                            <div class="aspect-[4/3] bg-gray-200 rounded-xl overflow-hidden relative">
                                ...
                                <div class="absolute bottom-2 right-2 z-10 flex gap-1">
                                    ...
                                    <div class="bg-red-700 text-white p-1.5 rounded-full shadow-md" title="Audiodescripció (persones cegues)">
                                    ...
                                    <div class="bg-red-700 text-white p-1.5 rounded-full shadow-md" title="Transcripció (persones sordes)">
                                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="mt-3">
                            <h3 class="text-2xl font-semibold text-gray-900 group-hover:text-red-700 transition-colors">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    @foreach($documents as $document)
                        <a
                            ...
                            class="flex items-center gap-4 p-4 bg-white rounded-xl border border-gray-200 hover:border-red-300 hover:shadow-md transition group"
                        >
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="font-medium text-gray-900 group-hover:text-red-700 transition truncate">
                                    {{ $document->titol }}
                                </h3>
                            ...
                            <svg class="w-5 h-5 text-gray-400 group-hover:text-red-700 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24">
