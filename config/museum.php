...
return [
    ...
    */
    ...
    | Primary Color
    |--------------------------------------------------------------------------
    | The primary accent color used throughout the entire app.
    | This affects both the public frontend AND the admin panel.
    |
    | Available presets:
    |   red, orange, amber, yellow, lime, green, emerald, teal,
    |   cyan, sky, blue, indigo, violet, purple, fuchsia, pink, rose
    |
    | You can also define custom colors using MUSEUM_COLOR_* env vars.
    */
    ...
    | Hero Gradient
    |--------------------------------------------------------------------------
    | The gradient used in the hero section of the home page.
    | Format: "from-color via-color to-color" (Tailwind gradient classes)
    | Leave empty to use auto-generated gradient from primary color.
    */
    'hero_gradient' => env('MUSEUM_HERO_GRADIENT', ''),
    ...
    */
    ...
    | Color Palettes
    |--------------------------------------------------------------------------
    | Tailwind CSS color palettes for the primary accent color.
    | Each palette defines shades from 50 (lightest) to 950 (darkest).
    | The primary_color setting above selects which palette to use.
    |
    | You can override individual shades via environment variables:
    |   MUSEUM_COLOR_500=#your_hex_color
    |   MUSEUM_COLOR_700=#your_hex_color
    */
    'palettes' => [
        'red' => [
